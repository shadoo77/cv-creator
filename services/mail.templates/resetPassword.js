                  ...
                  >
                    <tr>
                      ...
                      >
                        ...
                        >
                        Beste <strong>${data.name}</strong>,
                        </p>
                        <p
                          style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"
                        >
                        Er is via de website een aanvraag gedaan om uw wachtwoord te wijzigen.
                        </p>
                        <p style="color: blue">
                        Om uw wachtwoord te kunnen wijzigen , klik op de link hier :
                        </p>
                        <table
                          border="0"
                          cellpadding="0"
                                ...
                                >
                                  <tbody>
                                    <tr>
                                      ...
                                      >
                                        <a 
                                          href=http://localhost:3000/resetPassword/${data.token}
                                          target="_blank"
                        ...
                        Uw wachtwoord wordt dan niet gewijzigd.
                        </p>
                        <p
                          style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"
                        >
